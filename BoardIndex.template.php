		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				if (!empty($board['children']))
				{
					...
					echo '
					<p class="children windowbg" id="board_', $board['id'], '_children">
...
function template_info_center()
{
	...
	<div class="boardindex-infocenter" id="upshrinkHeaderIC"', empty($options['collapse_header_ic']) ? '' : ' style="display: none;"', '>
